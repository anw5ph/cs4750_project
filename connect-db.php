...
$username = 'root';
$password = 'wahoowa2O24!?';
$host = 'cs4750db-365920:us-east4:db-project';       // e.g., 'cs4750:us-east4:db-demo'; 
$dbname = 'checkbook';        // e.g., 'guestbook';
$dsn = "mysql:host=34.85.161.115;dbname=checkbook";   // connect PHP (XAMPP) to DB (GCP)
